    ...
    <div className="bg-off-white text-black h-svh px-[5%] w-full pt-[11%] flex flex-col gap-y-3 overflow-hidden">
      ...
      <div className="relative flex-1  mb-44 w-full  flex">
        ...
        <div className="flex z-10 w-[90vw] mx-auto h-[70%] relative">
          ...
          <div
            className={`pl-2 w-full h-full flex flex-1 items-end transition-transform duration-1000
          ...
          >
            <p
              ...
              className="font-Edo  text-xl font-normal text-left uppercase text-white -mr-4"
            >
              EXPLORER
            </p>
          ...
          <div
            className={`mr-5 w-full  h-full flex flex-1 items-end  transition-transform duration-1000 
                       ${
                         animationCounter >= 2
                           ? "translate-x-0"
                           : "translate-x-48"
          ...
          >
            ...
            <p
              ...
              className="font-Edo  text-xl font-normal text-left uppercase text-white -ml-4"
            >
              EXPLORER
            </p>
          </div>
