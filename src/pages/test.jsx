          ...
          `}
              >
                <p
                  ...
                  className="overflow-y-auto whitespace-nowrap font-Edo h-1/2 self-end text-right text-xl leading-6 font-normal uppercase text-white"
                >
            ...
            `}
              >
                ...
                <p
                  ...
                  className="overflow-y-auto whitespace-nowrap font-Edo  text-xl leading-6 h-1/2 self-end text-left font-normal uppercase text-white"
                >
